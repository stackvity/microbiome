...
/**
 * A foundational, accessible input component based on shadcn/ui,
 * styled according to the Biomevity design system for text, password, email, etc.
 */
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        // Applies consistent styling including border, background, focus states, and disabled states
        className={cn(
