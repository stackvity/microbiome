...
Description: Foundational Navigation Menu component based on shadcn/ui (Radix Navigation).
Task ID: FE-030 (Related to US-FE-015)
Status: Revised (No changes from baseline based on analysis)
-------------------------------------------------------------------------------
*/
